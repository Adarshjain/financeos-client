...
export const TRANSACTIONS_CATALOG: DatasourceCatalog = {
  ...
  fields: [
    ...
    { name: 'source', label: 'Source', type: 'enum', role: 'filter', values: ['gmail_transaction_alert', 'gmail_statement', 'manual'], allowedInReports: [] },
    ...
    { name: 'reviewType', label: 'Review Type', type: 'enum', role: 'filter', values: ['NEEDS_REVIEW', 'AUTO_REVIEWED', 'MANUALLY_REVIEWED'], allowedInReports: [] },
