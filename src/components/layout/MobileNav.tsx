...
export function MobileNav({ userEmail }: MobileNavProps) {
  ...
  return (
    <nav
      className="lg:hidden fixed bottom-0 left-0 right-0 h-14 bg-white/95 dark:bg-slate-900/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-slate-900/60 border-b border-slate-200 dark:border-slate-800 z-40 flex items-center justify-between px-4 border-t">
      {navItems.map((item) => {
        const isActive =
