      ...
      <DialogContent className="sm:max-w-5xl">
        ...
        <DialogBody className="space-y-1">
              ...
              {isLoadingCardSummary ? (
                ...
                <div
                  ...
                  <div
                    ...
                    <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase">Total Amount Due</span>
                  ...
                  <div className="md:col-span-3 grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                    ...
                    <div>
                      <div className="flex justify-between items-center text-xs text-slate-400 dark:text-slate-500">
                        ...
                        <span
                          className={cn('font-bold tabular-nums', cardSummary.utilizationPct !== null && cardSummary.utilizationPct !== undefined ? (cardSummary.utilizationPct < 30 ? 'text-emerald-600 dark:text-emerald-400' : cardSummary.utilizationPct < 70 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400') : 'text-slate-700 dark:text-slate-300')}>
                      ...
                      {cardSummary.utilizationPct !== null && cardSummary.utilizationPct !== undefined ? (
                        <div className="w-full h-1.5 bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden mt-1.5">
                          <div
                            className={cn('h-full rounded-full transition-all duration-300', cardSummary.utilizationPct < 30 ? 'bg-emerald-500' : cardSummary.utilizationPct < 70 ? 'bg-amber-500' : 'bg-rose-500')}
          ...
          {isLoading ? (
            ...
            <div
              className="p-4 rounded-xl bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/50 text-rose-700 dark:text-rose-400 flex items-center gap-2 text-sm">
                      ...
                      <div
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span
                              className="text-2xs uppercase bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded text-slate-500 dark:text-slate-400">
