            ...
            <Fragment key={i}>
              {i > 0 && (
                <div className="relative flex justify-center items-center my-1">
                  ...
                  <span className="relative z-10 px-2.5 py-0.5 rounded-full text-2xs font-bold bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 border border-slate-200/40 dark:border-slate-700/40 tracking-wider uppercase shadow-none">
                    and
                  </span>
                </div>
              )}
