...
export function LoanDetail({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Layer-1 Match Suggestions Inline Banner */}
      <div className="bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/50 rounded-xl p-4 space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-slate-900 dark:text-slate-100">
              Layer-1 EMI Transaction Matching
            </span>
          </div>
        ...
        {matchSuggestions && (
          <div className="space-y-2 text-xs pt-1">
            {matchSuggestions.suggestions.length === 0 ? (
              <p className="text-slate-500 italic">No unsettled installments due within next 7 days.</p>
            ) : (
