                    ...
                    <CardContent>
                        {accounts.length === 0 ? (
                            <div className="text-center py-12">
                                <p className="text-slate-600 dark:text-slate-400 mb-2">No accounts yet</p>
                                <p className="text-sm text-slate-500">Add your first account to get started!</p>
                            </div>
                        ) : (
                            <>
                                {/* Mobile View */}
                                            ...
                                            <DataListItem key={account.id}>
                                                <Link href={`/accounts/${account.id}`} className="block">
                                                    <DataListRow>
                                                        ...
                                                        <DataListValue
                                                            className="font-semibold text-emerald-600 dark:text-emerald-400">{account.name}</DataListValue>
                                                    </DataListRow>
                                                    <DataListRow>
                                                        <DataListLabel>Type</DataListLabel>
                                                        <DataListValue>
                                                            <Badge
                                                                variant="secondary">{getAccountTypeLabel(account.type)}</Badge>
                                                        </DataListValue>
                                                    </DataListRow>
                                                    <DataListRow>
                                                    ...
                                                    {account.description && (
                                                        <DataListRow>
                                                            ...
                                                            <DataListValue
                                                                className="text-slate-600 dark:text-slate-400">{account.description}</DataListValue>
                                                        </DataListRow>
                                                    )}
                                                </Link>
                                            </DataListItem>
