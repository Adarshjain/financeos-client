...
export function CreateAccountForm() {
    const [state, formAction] = useFormState(createAccount, null as ApiResult<AccountResponse> | null);
            ...
            <DialogContent>
                ...
                <form action={formAction} className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <label htmlFor="excludeFromNetAsset" className="text-sm text-slate-700 dark:text-slate-300">
