            ...
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 text-center max-w-md w-full">
                {status === 'loading' && (
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 dark:text-slate-400">Please wait while we verify your Google account.</p>
                        </div>
                    </div>
                )}
                ...
                {status === 'success' && (
                    <div className="flex flex-col items-center gap-4">
                        <Loader2 className="h-12 w-12 text-emerald-600 animate-spin" />
                        <div className="space-y-2">
                            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Success!</h2>
